...
def get_rviz_config_file(context):
    ...
    # 定义各个 rviz 配置文件路径
    rviz_description_config = os.path.join(ugv_description_dir, 'rviz', 'display.rviz')
...
def launch_setup(context, *args, **kwargs):
    ...
    urdf_model_path = os.path.join(
        FindPackageShare(package='ugv_description').find('ugv_description'), 'urdf/ugv_description.urdf')
